...
export default function TermsAndConditionsClient() {
  ...
  const fetchPolicyData = async () => {
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/user/static-pages/terms_and_conditions_n4z33f`)
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: "Fanboxes terms of service and legal conditions",
            url: `${process.env.NEXT_PUBLIC_SITE_URL || "https://fanboxes.com"}/terms-and-conditions`,
            breadcrumb: {
              "@type": "BreadcrumbList",
              itemListElement: [
                {
                ...
                },
                {
                  ...
                  position: 2,
                  name: "Terms and Conditions",
                  item: `${process.env.NEXT_PUBLIC_SITE_URL || "https://fanboxes.com"}/terms-and-conditions`,
                },
              ],
            },
          }),
      ...
      <main className="flex-1 pt-32 pb-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">{policyData?.title || "Terms and Conditions"}</h1>
          ...
          <div className="bg-white rounded-2xl shadow-sm p-8 mb-8 border border-gray-100">
            {policyData?.htmlContent ? (
              ...
              <div className="text-center text-gray-500 py-8">
                <p className="text-lg mb-4">No terms and conditions content available.</p>
          ...
          <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-8 mb-12 text-white">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <p className="text-slate-300 mb-2">For terms-related inquiries:</p>
                <p className="font-medium">
                  Email:{" "}
                  <a href="mailto:legal@fanboxes.com" className="text-[#11F2EB] hover:text-[#0ED9D3] transition-colors">
                    legal@fanboxes.com
                  </a>
                </p>
              </div>
