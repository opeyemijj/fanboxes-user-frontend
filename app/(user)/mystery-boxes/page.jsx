...
// Fallback data for demonstration (moved outside component)
const fallbackBoxes = [
  {
    id: 1,
    title: "Tech Bundle",
...
export default function MysteryBoxesPage() {
  ...
  const enhancedMysteryBoxes = enhancedData?.enhancedMysteryBoxes || [];
  ...
  if (typeof window === "undefined" || isDataLoading || productsLoading) {
    return (
        ...
        <main className="container mx-auto px-4 sm:px-6 lg:px-8 pt-24">
          <div className="flex items-center justify-center h-64">
            <div className="flex flex-col items-center">
              ...
              <p className="mt-4 text-lg">Loading mystery boxes...</p>
            </div>
          </div>
        </main>
        <Footer />
