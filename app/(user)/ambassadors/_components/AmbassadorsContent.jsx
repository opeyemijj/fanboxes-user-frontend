...
function AmbassadorsContent() {
  ...
  const { shops, categories, isLoading: dataLoading, hasError } = useInitialDataFetch()
  ...
  const scrollToAmbassadorsSection = useCallback(() => {
    if (ambassadorsSectionRef.current) {
      ...
      const scrollPosition = Math.max(0, sectionTop - stickyNavHeight - headerOffset)
  ...
  useEffect(() => {
    if (!isClient || shopsLoading || hasProcessedQuery || shopsData.length === 0) {
      return
    }
    ...
    if (categoryFromQuery) {
      ...
      const matchingShop = shopsData.find(
        (shop) =>
          shop.categoryDetails?.name?.toLowerCase() === decodedCategory.toLowerCase() ||
          shop.categoryDetails?.slug?.toLowerCase() === decodedCategory.toLowerCase(),
      )

      if (matchingShop) {
        console.log("✅ Found matching shop, setting category:", matchingShop.category)
        ...
        if (matchingCategory) {
          console.log("✅ Found matching category, setting:", matchingCategory._id)
        ...
        <main className="container mx-auto px-4 sm:px-6 lg:px-8 pt-24">
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-600 mb-2">Error loading ambassadors</h3>
              <p className="text-gray-500 mb-4">{shopError || hasError || "Unknown error occurred"}</p>
              <button
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "CollectionPage",
            name: "Fanboxes Ambassadors",
            description: "Discover content creators and influencers offering exclusive mystery boxes",
            url: `${process.env.NEXT_PUBLIC_SITE_URL || "https://fanboxes.com"}/ambassadors`,
            breadcrumb: {
              "@type": "BreadcrumbList",
              itemListElement: [
                {
                ...
                },
                {
                  ...
                  position: 2,
                  name: "Ambassadors",
                  item: `${process.env.NEXT_PUBLIC_SITE_URL || "https://fanboxes.com"}/ambassadors`,
                },
              ],
            },
          }),
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 pt-24">
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <h1 className="text-2xl sm:text-3xl lg:text-5xl font-bold">Ambassadors</h1>
          </div>
          ...
          <div className="flex flex-col gap-8 mt-4">
            ...
            {randomizedPopularAmbassadors.length > 0 && (
              <section>
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Popular Ambassadors</h2>
                  <span className="text-sm text-gray-500">{randomizedPopularAmbassadors.length} popular</span>
                </div>
            ...
            <div ref={ambassadorsSectionRef}>
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Our Ambassadors</h2>
              ...
              <div className="p-5 rounded-lg bg-[#EFEFEF]">
                {paginatedAmbassadors.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    <p className="text-gray-500">No ambassadors match your filters</p>
                    <button
                      onClick={() => {
