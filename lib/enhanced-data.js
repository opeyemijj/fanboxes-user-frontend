...
export const enhancedAmbassadors = [
  ...
  },
  {
    ...
    badge: "NEW",
    category: "lifestyle",
    description: "Lifestyle content creator with amazing picks for modern living",
    followers: "950K",
    totalBoxes: 8,
    isVerified: true,
    socialLinks: {
  ...
  },
  {
    ...
    badge: "POPULAR",
    category: "gaming",
    description: "Professional gamer curating the best gaming gear and collectibles",
    followers: "1.5M",
    totalBoxes: 22,
    isVerified: true,
    socialLinks: {
  ...
  },
  {
    ...
    badge: "NEW",
    category: "fitness",
    description: "Certified trainer sharing the best fitness and health products",
    followers: "800K",
    totalBoxes: 10,
    isVerified: true,
    socialLinks: {
  ...
  },
  {
    ...
    badge: "NEW",
    category: "sports",
    description: "Professional athlete sharing premium sports gear and collectibles",
    followers: "1.2M",
    totalBoxes: 14,
    isVerified: true,
    socialLinks: {
...
export const enhancedMysteryBoxes = [
  {
    ...
    description: "Latest tech gadgets and accessories curated by tech expert Mike",
    totalValue: 500,
    itemCount: 8,
    rarity: "rare",
  },
  ...
  },
  {
    ...
    isTrending: false,
    creatorAvatar: "/images/profile3bg.png",
    description: "Essential fitness gear and supplements for your workout routine",
    totalValue: 250,
    itemCount: 9,
    rarity: "common",
  },
  ...
  },
  {
    ...
    isTrending: false,
    creatorAvatar: "/images/profile2bg.png",
    description: "Premium sports gear and memorabilia from professional athletes",
    totalValue: 400,
    itemCount: 8,
    rarity: "rare",
  },
...
export const filterBoxesByCreator = (boxes, creatorId) => {
  return boxes.filter((box) => box.creatorId === creatorId)
}
...
export const sortBoxes = (boxes, sortBy) => {
  switch (sortBy) {
    ...
    case "most-popular":
    default:
      return [...boxes].sort((a, b) => (b.isTrending ? 1 : 0) - (a.isTrending ? 1 : 0))
  }
}
...
export const searchAmbassadors = (ambassadors, searchTerm) => {
  ...
  return ambassadors.filter(
    (ambassador) => ambassador.name.toLowerCase().includes(term) || ambassador.description.toLowerCase().includes(term),
  )
}
